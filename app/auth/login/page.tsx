  ...
  return (
    <>
      ...
      <div className="auth-page">
        ...
        <div className="auth-form-section">
          <div className="auth-form-wrapper">
            ...
            <div className="auth-header">
              ...
              <h1>Bon retour !</h1>
              <p>Connectez-vous pour acc&eacute;der &agrave; votre tableau de bord</p>
            </div>
            ...
            <p className="auth-footer-text">
              ...
              <Link href="/auth/signup">Cr&eacute;er un compte</Link>
            </p>
          </div>
        </div>
        ...
        <div className="auth-visual-section">
          <div className="visual-content">
            ...
            <p>
              Rejoignez les entreprises qui ont transform&eacute; leur productivit&eacute;
              gr&acirc;ce &agrave; nos agents IA sp&eacute;cialis&eacute;s.
            </p>
            <div className="visual-features">
              ...
              <div className="visual-feature">
                <span>Donn&eacute;es 100% s&eacute;curis&eacute;es</span>
              </div>
              <div className="visual-feature">
                <span>8 agents sp&eacute;cialis&eacute;s</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        .form-group label { display: flex; justify-content: space-between; align-items: center; font-size: 0.9rem; font-weight: 500; color: var(--text-primary); margin-bottom: 8px; }
        ...
        .form-group input[type="email"], .form-group input[type="password"] { width: 100%; padding: 14px 18px 14px 48px; border: 1px solid var(--border-color); border-radius: 12px; background: var(--bg-secondary); font-size: 1rem; color: var(--text-primary); transition: all 0.3s ease; }
        ...
        .checkbox-custom { width: 20px; height: 20px; border: 2px solid var(--border-color); border-radius: 6px; transition: all 0.3s ease; position: relative; }
        ...
        .auth-visual-section::before { content: ''; position: absolute; top: -50%; right: -30%; width: 100%; height: 200%; background: radial-gradient(circle, rgba(255,255,255,0.1) 0%, transparent 60%); }
        ...
        .visual-content > p { font-size: 1.1rem; line-height: 1.6; margin-bottom: 40px; color: rgba(255,255,255,0.9) !important; }
        .visual-features { display: flex; flex-direction: column; gap: 16px; }
        .visual-feature { display: flex; align-items: center; gap: 12px; font-size: 1rem; color: #FFFFFF !important; }
